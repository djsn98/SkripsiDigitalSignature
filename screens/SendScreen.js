...
const DataProvidedSendScreen = ({ route, navigation }) => {
    ...
    return (
        <View>
            ...
            />
            <View style={{ marginTop: 410, position: 'absolute', elevation: 5, paddingRight: 5, justifyContent: 'center', alignItems: 'center', marginLeft: 275, borderRadius: 50, backgroundColor: '#2196F3', width: 72, height: 72 }}>
                <TouchableOpacity
                    onPress={() => {
